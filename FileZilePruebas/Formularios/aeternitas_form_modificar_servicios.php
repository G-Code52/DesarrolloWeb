...
<body>
	<div id="general">
		<div id="form_alta">
			...
			<form name="fvalida" method="POST" action="../PHP_Aeternitas/aeternitas_modificar_servicios.php" enctype="multipart/form-data">
				<table class="table table-striped" id="tabla_iniciosesion" >
					<tr>
					<td><label for="id"><font color="red" size="5" face="Verdana">*</font>ID a modificar:</label></td>
