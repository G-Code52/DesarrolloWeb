...
<body>
	...
	<div id="general">
		<div id="form_alta">
			...
			<form name="fvalida" method="POST" action="../PHP_Aeternitas/aeternitas_eliminar_proovedores.php">
				...
				<tr>
				<td colspan="2"><input type="submit" class="btn btn-primary" value="Enviar" onclick="valida_envia()"></td>
			  </tr>
			  </table>
			</form>
		</div>
