...
<form id="searchForm" name="searchForm" method="POST" action="visualiza_cliente.php">
...
$sql = "SELECT * FROM at_clientes WHERE nombre LIKE '%$searchTerm%'";
