...
<form id="searchForm" name="searchForm" method="POST" action="visualiza_proveedor.php">
...
$sql = "SELECT * FROM at_proveedores WHERE tipoinsumo LIKE '%$searchTerm%'";
...
if ($result->num_rows > 0) {
    ...
    echo "<tr>";
    echo "<th>ID</th>";
    echo "<th>Tipo Insumo</th>";
    echo "<th>Nombre de la Empresa</th>";
    echo "<th>Telefono</th>";
    echo "<th>Descrpcion</th>";
    echo "<th>Precio Servicio</th>";
    echo "</tr>";

    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td>".$row["id"]."</td>";  
        echo "<td>".$row["tipoinsumo"]."</td>";
        echo "<td>".$row["nombreempresa"]."</td>";
        echo "<td>".$row["telefono"]."</td>";
        echo "<td>".$row["descripcion"]."</td>";
        echo "<td>".$row["precioservicio"]."</td>";
        echo "</tr>";
    }
